...
**      a deployment then the definition of the HI_WORLD_REV
**      macro in hi_world_platform_cfg.h should be updated.
**
*/
#ifndef _app_cfg_
#define _app_cfg_
...
#include "app_c_fw.h"
#include "hi_world_platform_cfg.h"
#include "hi_world_eds_typedefs.h"
...
#define  HI_WORLD_MAJOR_VER   1
#define  HI_WORLD_MINOR_VER   0
...
#define HI_WORLD_BASE_EID  (APP_C_FW_APP_BASE_EID +  0)
