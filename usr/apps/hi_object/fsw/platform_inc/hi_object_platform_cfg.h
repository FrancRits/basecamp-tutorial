...
**
**  Purpose:
**    Define platform configurations for the Hi_object application
**
**  Notes:
...
**      the app for a particular platform. Use hi_object_mission_cfg.h
...
**
*/
#ifndef _hi_object_platform_cfg_
#define _hi_object_platform_cfg_
...
#include "hi_object_mission_cfg.h"
...
#define HI_OBJECT_PLATFORM_REV   0

// Do not use user supplied template to ensure filename length is less than default OS_MAX_FILE_NAME (includes \0)
#define HI_OBJECT_INI_FILENAME   "/cf/hi_object_ini.json"


#endif /* _hi_object_platform_cfg_ */
