...
**
**  Purpose:
**    Define configurations for the Hi_object application
**
**  Notes:
...
**      a deployment then the definition of the HI_OBJECT_REV
**      macro in hi_object_platform_cfg.h should be updated.
**
*/
#ifndef _app_cfg_
#define _app_cfg_
...
#include "app_c_fw.h"
#include "hi_object_platform_cfg.h"
#include "hi_object_eds_typedefs.h"
...
#define  HI_OBJECT_MAJOR_VER   1
#define  HI_OBJECT_MINOR_VER   0
...
//EX1
#define CFG_HI_OBJECT_CMD_TOPICID          HI_OBJECT_CMD_TOPICID
#define CFG_HI_OBJECT_EXE_TOPICID          BC_SCH_1_HZ_TOPICID
#define CFG_HI_OBJECT_SEND_STATUS_TOPICID  BC_SCH_4_SEC_TOPICID
#define CFG_HI_OBJECT_STATUS_TLM_TOPICID   HI_OBJECT_STATUS_TLM_TOPICID
...
#define APP_CONFIG(XX) \
   ...
   XX(HI_OBJECT_CMD_TOPICID,uint32) \
   XX(BC_SCH_1_HZ_TOPICID,uint32) \
   XX(BC_SCH_4_SEC_TOPICID,uint32) \
   XX(HI_OBJECT_STATUS_TLM_TOPICID,uint32) \
...
#define HI_OBJECT_BASE_EID  (APP_C_FW_APP_BASE_EID +  0)
